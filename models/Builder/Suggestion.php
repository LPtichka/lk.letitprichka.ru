...
use app\models\Repository\Suggestion\Data;

class Suggestion
{
    const EXCLUDED_SETTLEMENT_TYPES = [
        'мкр', 'тер', 'р-н', 'поселок', 'жилрайон', 'кв-л'
    ];

    /** @var \app\models\Repository\Suggestion\Suggestion */
    private $suggestion;
    ...
    public function __construct(array $suggestion)
    {
        ...
        $this->suggestion = new \app\models\Repository\Suggestion(
            $suggestion['value'],
    ...
    public function getSuggestion(): \app\models\Repository\Suggestion
    {
