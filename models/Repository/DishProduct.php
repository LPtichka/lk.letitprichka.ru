...
class DishProduct extends \yii\db\ActiveRecord
{
    ...
    {
        $this->weight = (new Weight())->convert($this->weight, Weight::UNIT_KG);
        $this->netto = (new Weight())->convert($this->netto, Weight::UNIT_KG);
        $this->brutto = (new Weight())->convert($this->brutto, Weight::UNIT_KG);
        $this->brutto_on_1_kg = (new Weight())->convert($this->brutto_on_1_kg, Weight::UNIT_KG);
