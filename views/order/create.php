...
?>
    ...
    echo $model->id; ?>">
        ...
        <div class="col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        if (!empty($model->getErrorMessages('customer'))): ?> has-error<?php
                                        endif; ?>"
                                        ">
                                ...
                                <div class="row" id="order-address-block">
                                    <div class="col-sm-8 select-block">
                                        ...
                                        if (!empty($model->getErrorMessages('address'))): ?> has-error<?php
                                        endif; ?>">
            ...
            <div class="col-sm-4">
                <div class="box box-primary" id="ordering-info">
                    <div class="box-header with-border">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h2 class="box-title"><?php
                            echo \Yii::t('order', 'Order exceptions'); ?></h2>
                    </div>
                    <div class="box-body">
                        <div class="exceptions" data-empty-text="<?php
                        echo \Yii::t('order', 'No exceptions'); ?>">
                            <?php
