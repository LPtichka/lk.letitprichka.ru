...
<?php if (empty($products)): ?>
    <div class="route-row">
        ...
        <div>
            ...
            <?php echo Html::dropDownList('menu_id', '', $menus, [
...
<?php else: ?>
    <div class="route-row">
        <div class="row header-table">
            <div class="col-sm-2"><?php echo \Yii::t('product', 'ID'); ?></div>
            <div class="col-sm-4"><?php echo \Yii::t('product', 'Name'); ?></div>
            <div class="col-sm-2"><?php echo \Yii::t('product', 'Available'); ?></div>
            <div class="col-sm-2"><?php echo \Yii::t('product', 'Required amount'); ?></div>
